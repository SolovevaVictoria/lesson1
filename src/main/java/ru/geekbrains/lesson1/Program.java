...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        Product chocolate1 = new Chocolate("Milka", "шоколад милка", 100, "молочный");
        System.out.println(chocolate1.displayInfo());

        Product chocolate2 = new Chocolate("Alpen Gold", "шоколад Alpen Gold", 105, "тёмный");
        System.out.println(chocolate2.displayInfo());

        Product chocolate3 = new Chocolate("Ritter Sport", "шоколад Ritter Sport", 155, "молочный");
        ...
        Chocolate chocolate4 = vendingMachine.getChocolate("молоч");
        if (chocolate4 == null){
